...
module Cadmium
  module LanguageDetector
    class LanguageDetector
      ...
      @@languages = Hash(String, Array(String)).new # Should be namedtuple
      def initialize
      ...
      def get_distances(text_trigrams : Hash(String, Int32), languages : Hash(String, Array(String)) = @@languages) : Hash(String, Int32)
      ...
      def get_distance(trigrams : Hash(String, Int32), model : Array(String)) : Int32
        distance = 0
        difference : Int32
